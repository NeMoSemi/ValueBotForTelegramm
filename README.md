...
<p>Для запуска программы установите все библиотеки записанные в requirements.txt, затем установите токен от своего бота в телеграмм в файле config.py и запустите main.py в python как исполняемый файл</p>
</a>
